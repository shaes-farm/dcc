...
(() => {
  const __ds_ns = (window.DCCDesignSystem_28b72e =
  ...
  try {
    (() => {
      ...
      function Select({ options = [], mono, style, ...rest }) {
        const [focus, setFocus] = React.useState(false);
        return /*#__PURE__*/ React.createElement(
          "div",
          {
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: "components/panels/EmptyState.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
      function ErrorCard({ title = "Provider unreachable", detail, action }) {
        return /*#__PURE__*/ React.createElement(
          "div",
          {
            style: {
    ...
    __ds_ns.__errors.push({
      path: "components/panels/ErrorCard.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
      function Panel({ title, asOf, actions, children, pad = true, style }) {
        return /*#__PURE__*/ React.createElement(
          "section",
          {
            style: {
    ...
    __ds_ns.__errors.push({
      path: "components/panels/Panel.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: "components/status/StatusBadge.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
      ...
      function StatusDot({ status = "unknown", size = 8, pulse }) {
        return /*#__PURE__*/ React.createElement(
          "span",
          {
            "aria-label": status,
    ...
    __ds_ns.__errors.push({
      path: "components/status/StatusDot.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: "components/panels/StatusBar.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: "components/status/Tag.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: "components/status/UriChip.jsx",
      error: String((e && e.message) || e),
    });
  }
      ...
      function Rail({ view, onNav, onPalette }) {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement("span", null, "Jump to\u2026"),
            /*#__PURE__*/ React.createElement("span", {
              style: {
                flex: 1,
              },
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(Tag, null, "Debugging"),
            /*#__PURE__*/ React.createElement(Tag, null, "Tech-lead"),
          ),
        );
      }
      function App() {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              cockpit
                ? /*#__PURE__*/ React.createElement(ServiceCockpit, {
                    onOpenPod: setPod,
          ...
          palette
            ...
            : null,
          pod
            ? /*#__PURE__*/ React.createElement(PodDrawer, {
                pod: pod,
                onClose: () => setPod(null),
                onRestart: () => setConfirm(true),
              })
  ...
  try {
                    ...
                    /*#__PURE__*/ React.createElement(
                      "div",
                      {
                        ...
                        style: {
                          ...
                          cursor: "pointer",
                          background:
                            i === sel ? "var(--accent-dim)" : "transparent",
                          borderLeft:
                            i === sel
                              ? "2px solid var(--accent)"
                              : "2px solid transparent",
                      ...
                      /*#__PURE__*/ React.createElement(Tag, null, r.kind),
                    ),
                  ),
            ),
            /*#__PURE__*/ React.createElement(
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              " ",
              /*#__PURE__*/ React.createElement(Tag, null, "shared"),
              " via ",
              /*#__PURE__*/ React.createElement("code", null, "k8s-qa"),
              ". Pods are never deleted directly. The action is audit-logged.",
            ),
            /*#__PURE__*/ React.createElement(UriChip, {
    ...
    __ds_ns.__errors.push({
      path: "ui_kits/dcc-app/Palette.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(Tag, null, "qa"),
              /*#__PURE__*/ React.createElement(Tag, null, "shared"),
              /*#__PURE__*/ React.createElement(Tag, null, "k8s-qa"),
            ),
            /*#__PURE__*/ React.createElement(
              "div",
              {
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                "div",
                null,
                "14:32 Pulled       image checkout:3.7.12",
              ),
              /*#__PURE__*/ React.createElement(
                "div",
                null,
    ...
    __ds_ns.__errors.push({
      path: "ui_kits/dcc-app/PodDrawer.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
      ...
      function LineageStrip() {
        ...
        const arr = /*#__PURE__*/ React.createElement(
          "span",
          {
            style: {
              color: "var(--text-3)",
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          D.context.map(([k, v, uri, prov]) =>
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(Tag, null, prov),
            ),
          ),
        );
      }
      function ServiceCockpit({ onOpenPod, onRestart }) {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(LineageStrip, null),
          /*#__PURE__*/ React.createElement(
            "div",
            {
              style: {
    ...
    __ds_ns.__errors.push({
      path: "ui_kits/dcc-app/ServiceCockpit.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: "ui_kits/dcc-app/WorkspaceHealth.jsx",
      error: String((e && e.message) || e),
    });
  }
